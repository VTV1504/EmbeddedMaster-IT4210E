...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "st_mnist_v1_28_tfs_int8"
...
#define AI_NETWORK_OUT_1_CHANNEL     (36)
#define AI_NETWORK_OUT_1_SIZE        (36)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (144)
